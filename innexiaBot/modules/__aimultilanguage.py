...
async def hmm(_, message):
    ...
    if status == "ON" or status == "on" or status == "On":
        ...
        if not lol:
            await lel.edit("𝐒ᴜᴢᴜɴᴇ ዘᴏʀɪᴋɪᴛᴀAI Already Activated In This Chat")
            return
        await lel.edit(
            f"𝐒ᴜᴢᴜɴᴇ ዘᴏʀɪᴋɪᴛᴀAI Successfully Added For Users In The Chat {message.chat.id}"
        )
        ...
        if not Escobar:
            await lel.edit("𝐒ᴜᴢᴜɴᴇ ዘᴏʀɪᴋɪᴛᴀAI Was Not Activated In This Chat")
            return
        await lel.edit(
            f"𝐒ᴜᴢᴜɴᴇ ዘᴏʀɪᴋɪᴛᴀAI Successfully Deactivated For Users In The Chat {message.chat.id}"
        )
...
__help__ = """
<b> Chatbot </b>
𝐒ᴜᴢᴜɴᴇ ዘᴏʀɪᴋɪᴛᴀAI 3.0 IS THE ONLY AI SYSTEM WHICH CAN DETECT & REPLY UPTO 200 LANGUAGES
