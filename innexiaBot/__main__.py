...
𝐒𝐨 𝐛𝐞 𝐦𝐲 𝐚𝐥𝐥𝐲 𝐚𝐧𝐝 𝐡𝐞𝐥𝐩 𝐦𝐞 𝐭𝐨 𝐜𝐨𝐧𝐪𝐮𝐞𝐫 𝐦𝐲 𝐠𝐨𝐚𝐥. 𝐌𝐲 𝐁𝐞𝐬𝐭 𝐚𝐥𝐥𝐲 ➪ @SimpleAsFuckAyanokojiOp.
...
buttons = [
    ...
    [
        InlineKeyboardButton(text="𝙷𝚎𝚕𝚙 & 𝙲𝚘𝚖𝚖𝚊𝚗𝚍𝚜", callback_data="innexia_"),
    ],
]

HELP_STRINGS = """
**𝐒ᴜᴢᴜɴᴇ ዘᴏʀɪᴋɪᴛᴀ Settings**
`Click The Help Buttons Which Are Relatable That You Think Off`)"""



DONATE_STRING = """No Need Sir Me Rich Thanks"""
    ...
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_photo(
            ...
            reply_markup=InlineKeyboardMarkup(
                [[InlineKeyboardButton(text="Sᴜᴘᴘᴏʀᴛ", url="https://t.me/Suzune_Support")]]
            ),
        )
...
def innexia_about_callback(update, context):
    ...
    if query.data == "innexia_":
        query.message.edit_text(
            text=""" 𝐒ᴜᴢᴜɴᴇ ዘᴏʀɪᴋɪᴛᴀ - A bot to manage your groups with additional features!
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="Bᴜɢ'ꜱ", url="https://t.me/Suzune_Support"
                        ),
                        InlineKeyboardButton(
                            text="Bᴏᴛ Lɪꜱᴛ", url="https://t.me/Suzune_Support"
                        ),
                    ],
        ...
        query.message.edit_text(
            ...
            f"\n• Than send `/admincache@Suzune_Superbot` in that chat to refresh admin list in My database.\n"
        ...
        query.message.edit_text(
            ...
            f"\nCongragulations, 𝐒ᴜᴢᴜɴᴇ ዘᴏʀɪᴋɪᴛᴀ now ready to manage your group."
            f"\n\n*Admin Tools*"
        ...
        query.message.edit_text(
            text="* 𝐒ᴜᴢᴜɴᴇ ዘᴏʀɪᴋɪᴛᴀ support chats*"
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="Sᴜᴘᴘᴏʀᴛ", url="https://t.me/Suzune_Support"),
                    InlineKeyboardButton(text="Uᴘᴅᴀᴛᴇꜱ", url="https://t.me/AyanokojiOp"),
                 ],
                 [
                    InlineKeyboardButton(text="Owner", url="t.me/SimpleAsFuckAyanokojiOp"),
                    InlineKeyboardButton(text="Credits", url="t.me/SOULxDED"),
                 ],
                 [
                    InlineKeyboardButton(text="Back", callback_data="innexia_basichelp"),
        ...
        query.message.edit_text(
            text=f"<b> CREDIT FOR 𝐒ᴜᴢᴜɴᴇ ዘᴏʀɪᴋɪᴛᴀ DEV'S</b>\n"
            f"\nHere Some Developers Helping in Making The Innexia Bot",
            parse_mode=ParseMode.HTML,
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="ꪶ࿋྄ིᤢꫂ 𝘬ꪖ​᭙ꪖ​𝘬𝓲 🖤🔥", url="t.me/Kawaki_106"),
                    InlineKeyboardButton(text="🔥⛦⃕͜𝙋𝙃𝙊𝛯𝙉𝙄𝑿🥀《ℂ𝕂𝔻》", url="t.me/SOULxDED"),
                 ],
                 [
                    InlineKeyboardButton(text="Rizoel", url="t.me/TheRiZoel"),
                    InlineKeyboardButton(text="♛𝘼𝘬ꫀꪑ𝙄 #AɪɴCʀᴀᴅ♛", url="https://t.me/DevilAkemi"),
                 ],
                 [
                    InlineKeyboardButton(text="Back", callback_data="innexia_basichelp"),
...
def Source_about_callback(update, context):
    ...
    if query.data == "source_":
        query.message.edit_text(
            text=""" Hi..😻 I'm *𝐒ᴜᴢᴜɴᴇ ዘᴏʀɪᴋɪᴛᴀ*
                 \nHere is the [Owner](t.me/SimpleAsFuckAyanokojiOp) .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
